...
useEffect(() => {
  ...
  // --- JSX ---
  return (
    <View style={{ flex: 1, backgroundColor: '#f8f8f8ff' }}>
      <ScrollView
        ref={scrollRef}
      ...
      >
        {imagePath ? (
        <View style={{height:150, width:'95%', borderRadius:20, backgroundColor:'#fff', marginVertical:10}}>
          <Image
        ...
        {visibleSteps
          ...
          >
            Step {idx + 1}
             ...
             {/* Optional explanation under equation (regular) */}
          {step.explanation ? (
            <Text
              style={{
                marginTop: 5,
      ...
      >
        ...
        >
          ...
          >
            {!isListening ? 
            <Ionicons name="mic-outline" size={30} style={{padding:15, borderColor:"#000", borderRadius:40, borderWidth:1}}/>
            :
            <Ionicons name="mic-off-outline" size={30} style={{padding:15, borderColor:"#000", borderRadius:40, borderWidth:1}}/>
            }
              {/* {isListening ? '🟢' : '🎤'} */}
            {/* </Text> */}
          </TouchableOpacity>
